...
fun assertIsEmpty(actual: String?, message: String? = null) {
    actual ?: { fail(message ?: "Expected collection not to be empty, but it's null.") }
...
fun assertIsEmpty(actual: Map<*, *>?, message: String? = null) {
    actual ?: { fail(message ?: "Expected map not to be empty, but it's null.") }
    assertTrue(actual!!.isEmpty(), message ?: "Expected map $actual to be empty")
}

fun assertNotEmpty(actual: String?, message: String? = null) {
    actual ?: { fail(message ?: "Expected string not to be empty, but it's null.") }
...
fun <T> assertDoesNotContain(iterable: Iterable<T>?, element: T, message: String? = null) {
    iterable ?: { fail(message ?: "Expected collection not to contain $element, but it's null.") }
...
fun <T> assertContains(iterable: Iterable<T>?, element: T, message: String? = null) {
    iterable ?: { fail(message ?: "Expected collection to contain $element, but it's null.") }
    kotlin.test.assertContains(iterable!!, element, message ?: "Expected $iterable not to contain $element")
}

fun assertTrue(actual: Boolean?, message: String? = null) {
    actual ?: { fail(message ?: "Expected value to be true, but it's null") }
    assertTrue(actual!!, message)
}

fun assertFalse(actual: Boolean?, message: String? = null) {
    actual ?: { fail(message ?: "Expected value to be false, but it's null") }
