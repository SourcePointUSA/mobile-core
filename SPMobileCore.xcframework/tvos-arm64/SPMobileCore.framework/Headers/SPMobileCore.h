...
- (instancetype)initWithAccountId:(int32_t)accountId propertyId:(int32_t)propertyId propertyName:(SPMCSPPropertyName *)propertyName campaigns:(SPMCSPCampaigns *)campaigns repository:(SPMCRepository *)repository timeoutInSeconds:(int32_t)timeoutInSeconds spClient:(id<SPMCSPClient>)spClient state:(SPMCState *)state authId:(NSString * _Nullable)authId __attribute__((swift_name("init(accountId:propertyId:propertyName:campaigns:repository:timeoutInSeconds:spClient:state:authId:)"))) __attribute__((objc_designated_initializer));
- (void)clearLocalData __attribute__((swift_name("clearLocalData()")));
...
- (instancetype)initWithSampleRate:(float)sampleRate wasSampled:(SPMCBoolean * _Nullable)wasSampled wasSampledAt:(SPMCFloat * _Nullable)wasSampledAt messagePartitionUUID:(NSString * _Nullable)messagePartitionUUID __attribute__((swift_name("init(sampleRate:wasSampled:wasSampledAt:messagePartitionUUID:)"))) __attribute__((objc_designated_initializer));
...
- (SPMCStateCCPAStateCCPAMetaData *)doCopySampleRate:(float)sampleRate wasSampled:(SPMCBoolean * _Nullable)wasSampled wasSampledAt:(SPMCFloat * _Nullable)wasSampledAt messagePartitionUUID:(NSString * _Nullable)messagePartitionUUID __attribute__((swift_name("doCopy(sampleRate:wasSampled:wasSampledAt:messagePartitionUUID:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (instancetype)initWithAdditionsChangeDate:(SPMCKotlinx_datetimeInstant *)additionsChangeDate sampleRate:(float)sampleRate wasSampled:(SPMCBoolean * _Nullable)wasSampled wasSampledAt:(SPMCFloat * _Nullable)wasSampledAt vendorListId:(NSString * _Nullable)vendorListId applicableSections:(NSArray<NSString *> *)applicableSections legislation:(NSString * _Nullable)legislation messagePartitionUUID:(NSString * _Nullable)messagePartitionUUID __attribute__((swift_name("init(additionsChangeDate:sampleRate:wasSampled:wasSampledAt:vendorListId:applicableSections:legislation:messagePartitionUUID:)"))) __attribute__((objc_designated_initializer));
...
@interface SPMCStatePreferencesStatePreferencesMetaData : SPMCBase <SPMCStateSPSampleable>
- (instancetype)initWithSampleRate:(float)sampleRate wasSampled:(SPMCBoolean * _Nullable)wasSampled wasSampledAt:(SPMCFloat * _Nullable)wasSampledAt configurationId:(NSString *)configurationId additionsChangeDate:(SPMCKotlinx_datetimeInstant *)additionsChangeDate legalDocLiveDate:(NSDictionary<SPMCPreferencesConsentPreferencesSubType *, SPMCKotlinx_datetimeInstant *> * _Nullable)legalDocLiveDate messagePartitionUUID:(NSString * _Nullable)messagePartitionUUID __attribute__((swift_name("init(sampleRate:wasSampled:wasSampledAt:configurationId:additionsChangeDate:legalDocLiveDate:messagePartitionUUID:)"))) __attribute__((objc_designated_initializer));
...
- (SPMCStatePreferencesStatePreferencesMetaData *)doCopySampleRate:(float)sampleRate wasSampled:(SPMCBoolean * _Nullable)wasSampled wasSampledAt:(SPMCFloat * _Nullable)wasSampledAt configurationId:(NSString *)configurationId additionsChangeDate:(SPMCKotlinx_datetimeInstant *)additionsChangeDate legalDocLiveDate:(NSDictionary<SPMCPreferencesConsentPreferencesSubType *, SPMCKotlinx_datetimeInstant *> * _Nullable)legalDocLiveDate messagePartitionUUID:(NSString * _Nullable)messagePartitionUUID __attribute__((swift_name("doCopy(sampleRate:wasSampled:wasSampledAt:configurationId:additionsChangeDate:legalDocLiveDate:messagePartitionUUID:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SPMCKotlinx_datetimeInstant *additionsChangeDate __attribute__((swift_name("additionsChangeDate")));
...
- (instancetype)initWithAdditionsChangeDate:(SPMCKotlinx_datetimeInstant *)additionsChangeDate sampleRate:(float)sampleRate wasSampled:(SPMCBoolean * _Nullable)wasSampled wasSampledAt:(SPMCFloat * _Nullable)wasSampledAt vendorListId:(NSString * _Nullable)vendorListId applicableSections:(NSArray<SPMCInt *> *)applicableSections messagePartitionUUID:(NSString * _Nullable)messagePartitionUUID __attribute__((swift_name("init(additionsChangeDate:sampleRate:wasSampled:wasSampledAt:vendorListId:applicableSections:messagePartitionUUID:)"))) __attribute__((objc_designated_initializer));
...
/**
 * @note This method converts instances of SPNetworkError, SPUnableToParseBodyError, CancellationException, HttpRequestTimeoutException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
...
- (instancetype)initWithAccountId:(SPMCInt * _Nullable)accountId authId:(NSString * _Nullable)authId uuid:(NSString * _Nullable)uuid messageId:(NSString * _Nullable)messageId vendorListId:(NSString * _Nullable)vendorListId pubData:(NSDictionary<NSString *, SPMCKotlinx_serialization_jsonJsonElement *> *)pubData pmSaveAndExitVariables:(NSDictionary<NSString *, SPMCKotlinx_serialization_jsonJsonElement *> *)pmSaveAndExitVariables sendPVData:(BOOL)sendPVData propertyId:(int32_t)propertyId sampleRate:(float)sampleRate granularStatus:(SPMCConsentStatusConsentStatusGranularStatus * _Nullable)granularStatus includeData:(SPMCIncludeData *)includeData prtnUUID:(NSString * _Nullable)prtnUUID __attribute__((swift_name("init(accountId:authId:uuid:messageId:vendorListId:pubData:pmSaveAndExitVariables:sendPVData:propertyId:sampleRate:granularStatus:includeData:prtnUUID:)"))) __attribute__((objc_designated_initializer));
...
@property (readonly) SPMCInt * _Nullable accountId __attribute__((swift_name("accountId")));
@property (readonly) NSString * _Nullable authId __attribute__((swift_name("authId")));
@property (readonly) SPMCConsentStatusConsentStatusGranularStatus * _Nullable granularStatus __attribute__((swift_name("granularStatus")));
@property (readonly) SPMCIncludeData *includeData __attribute__((swift_name("includeData")));
@property (readonly) NSString * _Nullable messageId __attribute__((swift_name("messageId")));
...
- (SPMCPreferencesChoiceRequest *)doCopyAccountId:(int32_t)accountId messageId:(NSString * _Nullable)messageId propertyId:(int32_t)propertyId authId:(NSString * _Nullable)authId uuid:(NSString * _Nullable)uuid pmSaveAndExitVariables:(NSDictionary<NSString *, SPMCKotlinx_serialization_jsonJsonElement *> *)pmSaveAndExitVariables includeData:(SPMCIncludeData *)includeData prtnUUID:(NSString * _Nullable)prtnUUID __attribute__((swift_name("doCopy(accountId:messageId:propertyId:authId:uuid:pmSaveAndExitVariables:includeData:prtnUUID:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int32_t accountId __attribute__((swift_name("accountId")));
...
@property (readonly) SPMCPvDataRequestPreferences * _Nullable preferences __attribute__((swift_name("preferences")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PvDataRequest.Preferences")))
@interface SPMCPvDataRequestPreferences : SPMCBase
- (instancetype)initWithUuid:(NSString * _Nullable)uuid accountId:(int32_t)accountId propertyId:(int32_t)propertyId pubData:(NSDictionary<NSString *, SPMCKotlinx_serialization_jsonJsonElement *> * _Nullable)pubData sampleRate:(SPMCFloat * _Nullable)sampleRate msgId:(SPMCInt * _Nullable)msgId prtnUUID:(NSString * _Nullable)prtnUUID __attribute__((swift_name("init(uuid:accountId:propertyId:pubData:sampleRate:msgId:prtnUUID:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SPMCPvDataRequestPreferencesCompanion *companion __attribute__((swift_name("companion")));
- (SPMCPvDataRequestPreferences *)doCopyUuid:(NSString * _Nullable)uuid accountId:(int32_t)accountId propertyId:(int32_t)propertyId pubData:(NSDictionary<NSString *, SPMCKotlinx_serialization_jsonJsonElement *> * _Nullable)pubData sampleRate:(SPMCFloat * _Nullable)sampleRate msgId:(SPMCInt * _Nullable)msgId prtnUUID:(NSString * _Nullable)prtnUUID __attribute__((swift_name("doCopy(uuid:accountId:propertyId:pubData:sampleRate:msgId:prtnUUID:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int32_t accountId __attribute__((swift_name("accountId")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PvDataRequest.PreferencesCompanion")))
@interface SPMCPvDataRequestPreferencesCompanion : SPMCBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SPMCPvDataRequestPreferencesCompanion *shared __attribute__((swift_name("shared")));
- (id<SPMCKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
- (instancetype)initWithAccountId:(SPMCInt * _Nullable)accountId authId:(NSString * _Nullable)authId uuid:(NSString * _Nullable)uuid messageId:(NSString * _Nullable)messageId vendorListId:(NSString * _Nullable)vendorListId pubData:(NSDictionary<NSString *, SPMCKotlinx_serialization_jsonJsonElement *> *)pubData pmSaveAndExitVariables:(NSDictionary<NSString *, SPMCKotlinx_serialization_jsonJsonElement *> *)pmSaveAndExitVariables sendPVData:(BOOL)sendPVData propertyId:(int32_t)propertyId sampleRate:(float)sampleRate idfaStatus:(SPMCSPIDFAStatus * _Nullable)idfaStatus granularStatus:(SPMCConsentStatusConsentStatusGranularStatus * _Nullable)granularStatus includeData:(SPMCIncludeData *)includeData prtnUUID:(NSString * _Nullable)prtnUUID __attribute__((swift_name("init(accountId:authId:uuid:messageId:vendorListId:pubData:pmSaveAndExitVariables:sendPVData:propertyId:sampleRate:idfaStatus:granularStatus:includeData:prtnUUID:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SPMCUSNatChoiceRequestCompanion *companion __attribute__((swift_name("companion")));
- (SPMCUSNatChoiceRequest *)doCopyAccountId:(SPMCInt * _Nullable)accountId authId:(NSString * _Nullable)authId uuid:(NSString * _Nullable)uuid messageId:(NSString * _Nullable)messageId vendorListId:(NSString * _Nullable)vendorListId pubData:(NSDictionary<NSString *, SPMCKotlinx_serialization_jsonJsonElement *> *)pubData pmSaveAndExitVariables:(NSDictionary<NSString *, SPMCKotlinx_serialization_jsonJsonElement *> *)pmSaveAndExitVariables sendPVData:(BOOL)sendPVData propertyId:(int32_t)propertyId sampleRate:(float)sampleRate idfaStatus:(SPMCSPIDFAStatus * _Nullable)idfaStatus granularStatus:(SPMCConsentStatusConsentStatusGranularStatus * _Nullable)granularStatus includeData:(SPMCIncludeData *)includeData prtnUUID:(NSString * _Nullable)prtnUUID __attribute__((swift_name("doCopy(accountId:authId:uuid:messageId:vendorListId:pubData:pmSaveAndExitVariables:sendPVData:propertyId:sampleRate:idfaStatus:granularStatus:includeData:prtnUUID:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SPMCInt * _Nullable accountId __attribute__((swift_name("accountId")));
...
- (instancetype)initWithSampleRate:(SPMCFloat * _Nullable)sampleRate configurationId:(NSString *)configurationId additionsChangeDate:(SPMCKotlinx_datetimeInstant * _Nullable)additionsChangeDate legalDocLiveDate:(NSDictionary<SPMCPreferencesConsentPreferencesSubType *, SPMCKotlinx_datetimeInstant *> * _Nullable)legalDocLiveDate __attribute__((swift_name("init(sampleRate:configurationId:additionsChangeDate:legalDocLiveDate:)"))) __attribute__((objc_designated_initializer));
...
- (SPMCMetaDataResponseMetaDataResponsePreferences *)doCopySampleRate:(SPMCFloat * _Nullable)sampleRate configurationId:(NSString *)configurationId additionsChangeDate:(SPMCKotlinx_datetimeInstant * _Nullable)additionsChangeDate legalDocLiveDate:(NSDictionary<SPMCPreferencesConsentPreferencesSubType *, SPMCKotlinx_datetimeInstant *> * _Nullable)legalDocLiveDate __attribute__((swift_name("doCopy(sampleRate:configurationId:additionsChangeDate:legalDocLiveDate:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SPMCKotlinx_datetimeInstant * _Nullable additionsChangeDate __attribute__((swift_name("additionsChangeDate")));
...
- (instancetype)initWithGdpr:(SPMCPvDataResponseCampaign * _Nullable)gdpr ccpa:(SPMCPvDataResponseCampaign * _Nullable)ccpa usnat:(SPMCPvDataResponseCampaign * _Nullable)usnat globalcmp:(SPMCPvDataResponseCampaign * _Nullable)globalcmp preferences:(SPMCPvDataResponsePreferencesCampaign * _Nullable)preferences __attribute__((swift_name("init(gdpr:ccpa:usnat:globalcmp:preferences:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SPMCPvDataResponseCompanion *companion __attribute__((swift_name("companion")));
- (SPMCPvDataResponse *)doCopyGdpr:(SPMCPvDataResponseCampaign * _Nullable)gdpr ccpa:(SPMCPvDataResponseCampaign * _Nullable)ccpa usnat:(SPMCPvDataResponseCampaign * _Nullable)usnat globalcmp:(SPMCPvDataResponseCampaign * _Nullable)globalcmp preferences:(SPMCPvDataResponsePreferencesCampaign * _Nullable)preferences __attribute__((swift_name("doCopy(gdpr:ccpa:usnat:globalcmp:preferences:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) SPMCPvDataResponsePreferencesCampaign * _Nullable preferences __attribute__((swift_name("preferences")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PvDataResponse.PreferencesCampaign")))
@interface SPMCPvDataResponsePreferencesCampaign : SPMCBase
...
@property (class, readonly, getter=companion) SPMCPvDataResponsePreferencesCampaignCompanion *companion __attribute__((swift_name("companion")));
- (SPMCPvDataResponsePreferencesCampaign *)doCopyUuid:(NSString * _Nullable)uuid __attribute__((swift_name("doCopy(uuid:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable uuid __attribute__((swift_name("uuid")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PvDataResponse.PreferencesCampaignCompanion")))
@interface SPMCPvDataResponsePreferencesCampaignCompanion : SPMCBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SPMCPvDataResponsePreferencesCampaignCompanion *shared __attribute__((swift_name("shared")));
- (id<SPMCKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@protocol SPMCKtor_ioCloseable <SPMCKotlinAutoCloseable>
@required
@end
...
@interface SPMCKotlinx_io_coreIOException : SPMCKotlinException
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (instancetype)initWithMessage:(NSString * _Nullable)message __attribute__((swift_name("init(message:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithCause:(SPMCKotlinThrowable * _Nullable)cause __attribute__((swift_name("init(cause:)"))) __attribute__((objc_designated_initializer));
...
*/
__attribute__((swift_name("Kotlinx_coroutines_coreCopyableThrowable")))
@protocol SPMCKotlinx_coroutines_coreCopyableThrowable
@required
- (SPMCKotlinThrowable * _Nullable)createCopy __attribute__((swift_name("createCopy()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Ktor_client_coreHttpRequestTimeoutException")))
@interface SPMCKtor_client_coreHttpRequestTimeoutException : SPMCKotlinx_io_coreIOException <SPMCKotlinx_coroutines_coreCopyableThrowable>
- (instancetype)initWithRequest:(SPMCKtor_client_coreHttpRequestBuilder *)request __attribute__((swift_name("init(request:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithRequest_:(SPMCKtor_client_coreHttpRequestData *)request __attribute__((swift_name("init(request_:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithUrl:(NSString *)url timeoutMillis:(SPMCLong * _Nullable)timeoutMillis cause:(SPMCKotlinThrowable * _Nullable)cause __attribute__((swift_name("init(url:timeoutMillis:cause:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (instancetype)initWithMessage:(NSString * _Nullable)message __attribute__((swift_name("init(message:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
- (instancetype)initWithCause:(SPMCKotlinThrowable * _Nullable)cause __attribute__((swift_name("init(cause:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
- (instancetype)initWithMessage:(NSString * _Nullable)message cause:(SPMCKotlinThrowable * _Nullable)cause __attribute__((swift_name("init(message:cause:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
- (SPMCKtor_client_coreHttpRequestTimeoutException *)createCopy __attribute__((swift_name("createCopy()")));
@end
...
- (void)setKey:(SPMCKtor_utilsAttributeKey<id> *)key value:(id)value __attribute__((swift_name("set(key:value:)")));
...
@protocol SPMCKtor_ioJvmSerializable
@required
@end
...
@interface SPMCKtor_httpUrl : SPMCBase <SPMCKtor_ioJvmSerializable>
...
@interface SPMCKtor_httpURLProtocol : SPMCBase <SPMCKtor_ioJvmSerializable>
