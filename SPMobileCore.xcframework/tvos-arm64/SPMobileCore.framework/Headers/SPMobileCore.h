...
- (instancetype)initWithAccountId:(int32_t)accountId propertyId:(int32_t)propertyId propertyName:(SPMCSPPropertyName *)propertyName campaigns:(SPMCSPCampaigns *)campaigns state:(SPMCState * _Nullable)state __attribute__((swift_name("init(accountId:propertyId:propertyName:campaigns:state:)"))) __attribute__((objc_designated_initializer));
