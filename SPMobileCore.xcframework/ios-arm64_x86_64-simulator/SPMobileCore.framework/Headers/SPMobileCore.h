...
- (instancetype)initWithGdpr:(SPMCPvDataResponseCampaign * _Nullable)gdpr ccpa:(SPMCPvDataResponseCampaign * _Nullable)ccpa usnat:(SPMCPvDataResponseCampaign * _Nullable)usnat globalcmp:(SPMCPvDataResponseCampaign * _Nullable)globalcmp preferences:(SPMCPvDataResponseCampaign * _Nullable)preferences __attribute__((swift_name("init(gdpr:ccpa:usnat:globalcmp:preferences:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SPMCPvDataResponseCompanion *companion __attribute__((swift_name("companion")));
- (SPMCPvDataResponse *)doCopyGdpr:(SPMCPvDataResponseCampaign * _Nullable)gdpr ccpa:(SPMCPvDataResponseCampaign * _Nullable)ccpa usnat:(SPMCPvDataResponseCampaign * _Nullable)usnat globalcmp:(SPMCPvDataResponseCampaign * _Nullable)globalcmp preferences:(SPMCPvDataResponseCampaign * _Nullable)preferences __attribute__((swift_name("doCopy(gdpr:ccpa:usnat:globalcmp:preferences:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) SPMCPvDataResponseCampaign * _Nullable preferences __attribute__((swift_name("preferences")));
