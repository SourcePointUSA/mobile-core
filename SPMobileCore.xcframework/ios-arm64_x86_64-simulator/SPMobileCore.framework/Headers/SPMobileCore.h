...
- (instancetype)initWithAccountId:(int32_t)accountId propertyId:(int32_t)propertyId propertyName:(SPMCSPPropertyName *)propertyName campaigns:(SPMCSPCampaigns *)campaigns __attribute__((swift_name("init(accountId:propertyId:propertyName:campaigns:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithAccountId:(int32_t)accountId propertyId:(int32_t)propertyId propertyName:(SPMCSPPropertyName *)propertyName campaigns:(SPMCSPCampaigns *)campaigns repository:(SPMCRepository *)repository spClient:(id<SPMCSPClient>)spClient authId:(NSString * _Nullable)authId state:(SPMCState *)state __attribute__((swift_name("init(accountId:propertyId:propertyName:campaigns:repository:spClient:authId:state:)"))) __attribute__((objc_designated_initializer));
- (void)clearLocalData __attribute__((swift_name("clearLocalData()")));
...
- (instancetype)initWithEnvironment:(SPMCSPCampaignEnv *)environment gdpr:(SPMCSPCampaign * _Nullable)gdpr ccpa:(SPMCSPCampaign * _Nullable)ccpa usnat:(SPMCSPCampaign * _Nullable)usnat ios14:(SPMCSPCampaign * _Nullable)ios14 __attribute__((swift_name("init(environment:gdpr:ccpa:usnat:ios14:)"))) __attribute__((objc_designated_initializer));
- (SPMCSPCampaigns *)doCopyEnvironment:(SPMCSPCampaignEnv *)environment gdpr:(SPMCSPCampaign * _Nullable)gdpr ccpa:(SPMCSPCampaign * _Nullable)ccpa usnat:(SPMCSPCampaign * _Nullable)usnat ios14:(SPMCSPCampaign * _Nullable)ios14 __attribute__((swift_name("doCopy(environment:gdpr:ccpa:usnat:ios14:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (instancetype)initWithGdpr:(SPMCSPUserDataSPConsent<SPMCGDPRConsent *> * _Nullable)gdpr ccpa:(SPMCSPUserDataSPConsent<SPMCCCPAConsent *> * _Nullable)ccpa usnat:(SPMCSPUserDataSPConsent<SPMCUSNatConsent *> * _Nullable)usnat __attribute__((swift_name("init(gdpr:ccpa:usnat:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SPMCSPUserDataCompanion *companion __attribute__((swift_name("companion")));
- (SPMCSPUserData *)doCopyGdpr:(SPMCSPUserDataSPConsent<SPMCGDPRConsent *> * _Nullable)gdpr ccpa:(SPMCSPUserDataSPConsent<SPMCCCPAConsent *> * _Nullable)ccpa usnat:(SPMCSPUserDataSPConsent<SPMCUSNatConsent *> * _Nullable)usnat __attribute__((swift_name("doCopy(gdpr:ccpa:usnat:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (instancetype)initWithGdpr:(SPMCSPUserDataSPWebConsentsSPWebConsent * _Nullable)gdpr ccpa:(SPMCSPUserDataSPWebConsentsSPWebConsent * _Nullable)ccpa usnat:(SPMCSPUserDataSPWebConsentsSPWebConsent * _Nullable)usnat __attribute__((swift_name("init(gdpr:ccpa:usnat:)"))) __attribute__((objc_designated_initializer));
...
- (SPMCSPUserDataSPWebConsents *)doCopyGdpr:(SPMCSPUserDataSPWebConsentsSPWebConsent * _Nullable)gdpr ccpa:(SPMCSPUserDataSPWebConsentsSPWebConsent * _Nullable)ccpa usnat:(SPMCSPUserDataSPWebConsentsSPWebConsent * _Nullable)usnat __attribute__((swift_name("doCopy(gdpr:ccpa:usnat:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property SPMCUSNatConsentUSNatUserConsents *userConsents __attribute__((swift_name("userConsents")));
@property (readonly) NSString * _Nullable uuid __attribute__((swift_name("uuid")));
@property (readonly) NSString * _Nullable webConsentPayload __attribute__((swift_name("webConsentPayload")));
@end
...
- (instancetype)initWithCode:(NSString *)code accountId:(NSString *)accountId description:(NSString *)description sdkVersion:(NSString *)sdkVersion osVersion:(NSString *)osVersion deviceFamily:(NSString *)deviceFamily propertyId:(NSString *)propertyId propertyName:(SPMCSPPropertyName *)propertyName campaignType:(SPMCSPCampaignType * _Nullable)campaignType __attribute__((swift_name("init(code:accountId:description:sdkVersion:osVersion:deviceFamily:propertyId:propertyName:campaignType:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (instancetype)initWithSeen0:(int32_t)seen0 env:(NSString * _Nullable)env scriptType:(NSString * _Nullable)scriptType scriptVersion:(NSString * _Nullable)scriptVersion serializationConstructorMarker:(id _Nullable)serializationConstructorMarker __attribute__((swift_name("init(seen0:env:scriptType:scriptVersion:serializationConstructorMarker:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly, getter=companion) SPMCErrorMetricsRequestCompanion *companion __attribute__((swift_name("companion")));
- (SPMCErrorMetricsRequest *)doCopyCode:(NSString *)code accountId:(NSString *)accountId description:(NSString *)description sdkVersion:(NSString *)sdkVersion osVersion:(NSString *)osVersion deviceFamily:(NSString *)deviceFamily propertyId:(NSString *)propertyId propertyName:(SPMCSPPropertyName *)propertyName campaignType:(SPMCSPCampaignType * _Nullable)campaignType __attribute__((swift_name("doCopy(code:accountId:description:sdkVersion:osVersion:deviceFamily:propertyId:propertyName:campaignType:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) SPMCSPPropertyName *propertyName __attribute__((swift_name("propertyName")));
...
- (instancetype)initWithAccountId:(int32_t)accountId propertyId:(int32_t)propertyId propertyName:(SPMCSPPropertyName *)propertyName requestTimeoutInSeconds:(int32_t)requestTimeoutInSeconds __attribute__((swift_name("init(accountId:propertyId:propertyName:requestTimeoutInSeconds:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithAccountId:(int32_t)accountId propertyId:(int32_t)propertyId propertyName:(SPMCSPPropertyName *)propertyName httpEngine:(id<SPMCKtor_client_coreHttpClientEngine>)httpEngine requestTimeoutInSeconds:(int32_t)requestTimeoutInSeconds __attribute__((swift_name("init(accountId:propertyId:propertyName:httpEngine:requestTimeoutInSeconds:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithAccountId:(int32_t)accountId propertyId:(int32_t)propertyId propertyName:(SPMCSPPropertyName *)propertyName httpEngine:(id<SPMCKtor_client_coreHttpClientEngine> _Nullable)httpEngine device:(SPMCDeviceInformation *)device version:(NSString *)version requestTimeoutInSeconds:(int32_t)requestTimeoutInSeconds __attribute__((swift_name("init(accountId:propertyId:propertyName:httpEngine:device:version:requestTimeoutInSeconds:)"))) __attribute__((objc_designated_initializer));
...
- (SPMCChoiceAllRequestChoiceAllCampaigns *)doCopyGdpr:(SPMCChoiceAllRequestChoiceAllCampaignsCampaign * _Nullable)gdpr ccpa:(SPMCChoiceAllRequestChoiceAllCampaignsCampaign * _Nullable)ccpa usnat:(SPMCChoiceAllRequestChoiceAllCampaignsCampaign * _Nullable)usnat __attribute__((swift_name("doCopy(gdpr:ccpa:usnat:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (instancetype)initWithGdpr:(SPMCChoiceAllResponseGDPR * _Nullable)gdpr ccpa:(SPMCChoiceAllResponseCCPA * _Nullable)ccpa usnat:(SPMCChoiceAllResponseUSNAT * _Nullable)usnat __attribute__((swift_name("init(gdpr:ccpa:usnat:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SPMCChoiceAllResponseCompanion *companion __attribute__((swift_name("companion")));
- (SPMCChoiceAllResponse *)doCopyGdpr:(SPMCChoiceAllResponseGDPR * _Nullable)gdpr ccpa:(SPMCChoiceAllResponseCCPA * _Nullable)ccpa usnat:(SPMCChoiceAllResponseUSNAT * _Nullable)usnat __attribute__((swift_name("doCopy(gdpr:ccpa:usnat:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
